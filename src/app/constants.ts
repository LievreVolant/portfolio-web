...
export const LINKS = {
    ...
    cleancode: 'https://damien.pobel.fr/post/clean-code/',
    ...
    dart: 'https://dart.dev/',
    dotnet: 'https://learn.microsoft.com/fr-fr/dotnet/framework/get-started/overview',
    ...
    mvvm: 'https://learn.microsoft.com/fr-fr/dotnet/architecture/maui/mvvm',
    lasalle: 'https://lasalle84.net/',
    licence: 'https://formations.univ-grenoble-alpes.fr/fr/catalogue-2021/licence-XA/licence-informatique-IAI7UC15.html',
    lua: 'https://www.lua.org/',
    ocaml: 'https://ocaml.org/',
    pasteur: 'https://www.stjeanpaul2.fr/lycee-louis-pasteur/',
...
export const PRJ_SRC = {
    ...
    shadowWitch: projectsPath + 'shadow-witch/shadow-witch.png',
